...
const CHRON_DIM_ORDER = ['unlock', 'access', 'permanence', 'catalyst', 'policy']
    ...
    <div>
      ...
      <div className="prod-header">
        ...
        <p className="prod-source">
          {parcel.address} — {parcel.neighborhood}, {parcel.city || 'Philadelphia'}
        </p>
      ...
      <div className="parcel-panel">
        ...
        <div className="parcel-grid">
          ...
          <div className="parcel-stat">
            ...
            <span>{formatNumber(parcel.lot_size_sqft)} sqft</span>
          </div>
          {parcel.constraints && parcel.constraints.length > 0 && (
            <div className="parcel-stat">
              <label>Constraints</label>
              <span>{parcel.constraints.join(', ')}</span>
            </div>
          )}
          {parcel.history && (
            <div className="parcel-stat">
      ...
      <div className="dim-panel">
        <h2 className="section-title">Chron Score</h2>
        <div className="dim-total-row">
          <span className="dim-total-num">{(scores.total || 0).toFixed(1)}</span>
          <span className="dim-total-label">Total Chron</span>
        </div>
        <div className="dim-grid">
          {CHRON_DIM_ORDER.map(dk => {
